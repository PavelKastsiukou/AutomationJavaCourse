...
public class VkApi2Testing {
    private static final Logger logger = Logger.getLogger(VkApi2Testing.class);
    ...
    public void apiVkPostTextOnTheWall() {
        ...
        logger.info("post_id = " + responseObject.get("post_id").toString());
        logger.info("Request - " + httpRequest);
        logger.info("Response - " + myResponseBody);
